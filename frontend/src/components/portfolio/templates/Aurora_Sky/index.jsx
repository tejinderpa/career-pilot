...
/**
 * Aurora Sky Portfolio Template
 * Category: 3D / WebGL
 * Description: Northern lights (aurora borealis) animation across the hero using CSS gradient animations. Icy blue/green/purple palette on a starry dark sky.
 */
    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center p-8 font-sans">
      <div className="max-w-3xl w-full text-center">
        ...
        <div className="p-8 border-2 border-dashed border-cyan-500/40 rounded-2xl bg-gray-900/50 backdrop-blur-sm">
          ...
          <h2 className="text-2xl font-bold text-gray-200 mb-3">Aurora Sky Template</h2>
          <p className="text-gray-400 mb-6 leading-relaxed">
            Northern lights (aurora borealis) animation across the hero using CSS gradient animations. Icy blue/green/purple palette on a starry dark sky.
          </p>
