...
/**
 * Bento Box Portfolio Template
 * Category: Glass / Modern UI
 * Description: Apple-style Bento box grid with mixed-size cards in a tight grid layout. Each card showcases a different aspect (photo, stat, skill, project).
 */
