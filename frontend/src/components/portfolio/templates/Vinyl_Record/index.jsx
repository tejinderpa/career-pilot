...
/**
 * Vinyl Record Portfolio Template
 * Category: Unique / Creative
 * Description: Spinning vinyl record hero animation. Projects listed as album tracks on a record sleeve. Music player-style section navigation with play/pause.
 */
    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center p-8 font-sans">
      <div className="max-w-3xl w-full text-center">
        ...
        <div className="p-8 border-2 border-dashed border-cyan-500/40 rounded-2xl bg-gray-900/50 backdrop-blur-sm">
          ...
          <h2 className="text-2xl font-bold text-gray-200 mb-3">Vinyl Record Template</h2>
          <p className="text-gray-400 mb-6 leading-relaxed">
            Spinning vinyl record hero animation. Projects listed as album tracks on a record sleeve. Music player-style section navigation with play/pause.
          </p>
