          ...
          {testimonials.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative bg-white border-2 border-black p-6 shadow-[6px_6px_0px_rgba(0,0,0,0.75)] transition-all duration-500 hover:-translate-y-2 hover:rotate-0 hover:shadow-[10px_10px_0px_rgba(0,0,0,0.65)] ${rotate}`}
              >
                {/* Fold corner */}
